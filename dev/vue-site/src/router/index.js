  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'taobao', name: 'boss-taobao', component: () => import('@/views/taobao/TaobaoModuleView.vue'), meta: { title: '淘宝运营', menuCode: 'boss.platform.taobao' } },
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'taobao', name: 'employee-taobao', component: () => import('@/views/taobao/TaobaoModuleView.vue'), meta: { title: '淘宝运营', menuCode: 'employee.platform.taobao' } },
