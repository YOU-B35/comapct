...
export const GUIDE_STEPS = [
  {
    title: '选择生成方式',
    body: '在底部输入提示词，或点「Agent」使用预设模板一键填入。可上传参考图做图生图。',
  },
  {
    title: '使用模板关键词',
    body: '预设模板已包含电商常用关键词（白底、场景、Hero 等），可直接改写后再生成。',
  },
  {
    title: '自定义关键词',
    body: '自定义模式可用「/」分隔多个关键词，例如：白底主图 / 柔光 / 无文字。',
  },
  {
    title: '选择数量并生成',
  ...
  {
    title: '注意事项',
    body: '提示词需合规，避免违规内容，否则可能判定失败（violation）。参考图建议单张不超过 8MB。',
  },
]
