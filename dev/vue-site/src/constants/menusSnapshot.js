...
export const SYS_MENU_SNAPSHOT = [
  ...
  { code: 'boss.ai_image', parent_code: null, portal: 'boss', platform: null, path: '/boss/ai-image', label: 'AI 生图', menu_type: 'base', sort_order: 15 },
  { code: 'boss.sau', parent_code: null, portal: 'boss', platform: null, path: '/boss/sau', label: '自媒体运营', menu_type: 'admin', sort_order: 18 },
  { code: 'boss.auto_upload', parent_code: null, portal: 'boss', platform: null, path: '/boss/auto-upload', label: '自动上货', menu_type: 'admin', sort_order: 19 },
  ...
  { code: 'boss.platform.taobao', parent_code: null, portal: 'boss', platform: 'taobao', path: '/boss/taobao', label: '淘宝运营', menu_type: 'module', sort_order: 75 },
  ...
  { code: 'boss.ops_teams', parent_code: 'boss.settings', portal: 'boss', platform: null, path: '/boss/ops-teams', label: '运营小组', menu_type: 'admin', sort_order: 121 },
  { code: 'boss.employees', parent_code: 'boss.settings', portal: 'boss', platform: null, path: '/boss/employees', label: '运营绑定', menu_type: 'admin', sort_order: 122 },
  { code: 'boss.warehouse_sites', parent_code: 'boss.settings', portal: 'boss', platform: null, path: '/boss/warehouse-sites', label: '仓库设置', menu_type: 'admin', sort_order: 123 },
  { code: 'boss.warehouse_staff', parent_code: 'boss.settings', portal: 'boss', platform: null, path: '/boss/warehouse-staff', label: '仓库人员', menu_type: 'admin', sort_order: 124 },
  ...
  { code: 'employee.ops_team', parent_code: null, portal: 'employee', platform: null, path: '/employee/ops-team', label: '我的小组', menu_type: 'module', sort_order: 86 },
  { code: 'employee.team_tasks', parent_code: null, portal: 'employee', platform: null, path: '/employee/team-tasks', label: '任务分配', menu_type: 'module', sort_order: 87 },
  { code: 'employee.team_binding', parent_code: null, portal: 'employee', platform: null, path: '/employee/team-binding', label: '运营绑定', menu_type: 'module', sort_order: 88 },
  ...
  { code: 'employee.sau', parent_code: null, portal: 'employee', platform: null, path: '/employee/sau', label: '自媒体运营', menu_type: 'module', sort_order: 95 },
  { code: 'employee.auto_upload', parent_code: null, portal: 'employee', platform: null, path: '/employee/auto-upload', label: '自动上货', menu_type: 'base', sort_order: 96 },
  ...
  { code: 'employee.ai_image', parent_code: null, portal: 'employee', platform: null, path: '/employee/ai-image', label: 'AI 生图', menu_type: 'base', sort_order: 101 },
  ...
  { code: 'employee.platform.taobao', parent_code: null, portal: 'employee', platform: 'taobao', path: '/employee/taobao', label: '淘宝运营', menu_type: 'module', sort_order: 65 },
