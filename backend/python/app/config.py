...
TEMU_API_REQUEST_TIMEOUT_MS = max(1_000, int(os.getenv("TEMU_API_REQUEST_TIMEOUT_MS", "45000")))
TEMU_API_MAX_RETRIES = max(0, int(os.getenv("TEMU_API_MAX_RETRIES", "2")))
TEMU_API_RETRY_BASE_SECONDS = max(0.1, float(os.getenv("TEMU_API_RETRY_BASE_SECONDS", "1.0")))
AE_API_MAX_RETRIES = max(0, int(os.getenv("AE_API_MAX_RETRIES", "2")))
AE_API_RETRY_BASE_SECONDS = max(0.1, float(os.getenv("AE_API_RETRY_BASE_SECONDS", "1.0")))
