...
/**
 * Pure upsert rules for Pdd content issues (spec: do not reopen resolved).
 * 对齐抖音 {@code DouyinIssueUpsert}。
 */
public final class PddIssueUpsert {
    private PddIssueUpsert() {}

    public static void applyIncoming(PddIssue row, Map<String, Object> incoming, String now, boolean isNew) {
