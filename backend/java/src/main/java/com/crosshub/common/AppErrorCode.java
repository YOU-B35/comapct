...
public enum AppErrorCode {
    ...
    ZINIAO_DISCOVER_FAILED("ZINIAO_DISCOVER_FAILED", "紫鸟店铺发现失败，请确认 Agent 与紫鸟 CLI 或 WebDriver 已启动"),

    MONITOR_TARGET_NOT_FOUND("MONITOR_TARGET_NOT_FOUND", "竞店监控目标不存在"),
    MONITOR_TARGET_URL_INVALID(
            "MONITOR_TARGET_URL_INVALID",
            "请填写支持平台的店铺或商品链接，链接参数不完整或不支持"
    ),
    ...
    A1688_PRODUCTS_NEED_DAY0("A1688_PRODUCTS_NEED_DAY0", "1688 商品接口尚未完成 Day0 探测，暂不可同步"),
    A1688_PRODUCTS_SYNC_FAILED("A1688_PRODUCTS_SYNC_FAILED", "1688 商品同步失败，请重试"),
    A1688_ORDERS_NEED_DAY0("A1688_ORDERS_NEED_DAY0", "1688 消费者订单接口尚未完成 Day0 探测，暂不可同步"),
    A1688_ORDERS_SOURCE_UNAVAILABLE("A1688_ORDERS_SOURCE_UNAVAILABLE", "无法获取 1688 订单列表，请检查后台改版或登录态"),
    A1688_ORDERS_SYNC_FAILED("A1688_ORDERS_SYNC_FAILED", "1688 订单同步失败，请重试"),
    A1688_SYNC_TIMEOUT("A1688_SYNC_TIMEOUT", "1688 同步超时，请重试"),
    A1688_PROFILE_BUSY("A1688_PROFILE_BUSY", "1688 浏览器任务进行中，请稍候"),
    ...
    static {
        ...
        BY_REASON.put("A1688_PRODUCTS_NEED_DAY0", A1688_PRODUCTS_NEED_DAY0);
        BY_REASON.put("A1688_PRODUCTS_SYNC_FAILED", A1688_PRODUCTS_SYNC_FAILED);
        BY_REASON.put("A1688_ORDERS_NEED_DAY0", A1688_ORDERS_NEED_DAY0);
        BY_REASON.put("A1688_ORDERS_SOURCE_UNAVAILABLE", A1688_ORDERS_SOURCE_UNAVAILABLE);
        BY_REASON.put("A1688_ORDERS_SYNC_FAILED", A1688_ORDERS_SYNC_FAILED);
        BY_REASON.put("A1688_SYNC_TIMEOUT", A1688_SYNC_TIMEOUT);
        BY_REASON.put("A1688_PROFILE_BUSY", A1688_PROFILE_BUSY);
        BY_REASON.put("1688 商品 Day0 未完成", A1688_PRODUCTS_NEED_DAY0);
        BY_REASON.put("1688 商品同步失败", A1688_PRODUCTS_SYNC_FAILED);
