...
/**
 * Pure upsert rules for Douyin content issues (spec: do not reopen resolved).
 */
public final class DouyinIssueUpsert {
    private DouyinIssueUpsert() {}

    public static void applyIncoming(DouyinIssue row, Map<String, Object> incoming, String now, boolean isNew) {
    ...
    public static String normalizeType(String type) {
        ...
        return switch (t) {
            ...
            case "live", "直播", "直播异常" -> "live";
            case "short_video", "shortvideo", "短视频", "短视频带货" -> "short_video";
